...
private
  ...
  def get_oidc_client
    OpenIDConnect::Client.new(
      identifier: Rails.configuration.oidc_client_id,
        secret: Rails.configuration.oidc_client_secret,
        redirect_uri: "#{Rails.configuration.base_url}/oidc/cb",
        host: Rails.configuration.oidc_host,
